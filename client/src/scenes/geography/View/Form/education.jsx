...
const AddEducation = () => {
  ...
  for (let i = 0; i <  props.educationFormData.Count ; i++) {
    Form.push(
      <div className={classes.instance} style={{border: "2px solid #13274F", borderRadius: "10px"}}>
    ...
    <>
      <form autoComplete="off" noValidate>
        <Card >
          ...
          <Button  className={classes.addButton} onClick={AddEducation} variant="contained">
            ADD EDUCATION
          </Button>
          </div>
        </Card>
